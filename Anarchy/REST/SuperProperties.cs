...
namespace Discord
{
    public class SuperProperties
    {
        ...
        public string UserAgent { get; set; } = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/92.0.4515.159 Safari/537.36";

        [JsonProperty("browser_version")]
        public string BrowserVersion { get; set; } = "92.0.4515.159";

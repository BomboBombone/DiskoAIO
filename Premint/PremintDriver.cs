...
namespace DiskoAIO.Premint
{
    class PremintDriver
    {
        ...
        public PremintDriver(string cookies)
        {
            Task.Run(() =>
            {
                try
                {
                    ...
                    driver.ExecuteScript($"window.location.href = \"https://www.premint.xyz/dashboard/\"");
            ...
            App.mainWindow.ShowNotification("Premint started, logging in. Please wait...");
        }
